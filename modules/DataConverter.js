...
/**
 * Converts the response to an array where each even element is a city name
 * and each odd is the population of the previous element
            ...
            return null;
             ...
             data.forEach(element => {
                 if(element.countryCode = countryCode){
                    ...
                    dataArray.push(element.population);
                    }
             });
            return dataArray;
        }
